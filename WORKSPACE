...
go_repository(
    ...
    sum = "h1:MgCgbr54Uo48j7km/po/ktcWYwufYOBM++5+3b0zTOs=",
    version = "v0.10.0",
)
...
go_repository(
    ...
    sum = "h1:lg0T1pZ/ROLIZBW/OUMtzpVcyTPniSLj63T+5AD0L5U=",
    version = "v0.10.0",
)
...
go_repository(
    ...
    sum = "h1:ov0+Bhfvpg4POSTOvH0Uw9wzaswlFvVGhiCmIyXNkkQ=",
    version = "v0.0.0-20200425101607-48f605c3b60a",
)
