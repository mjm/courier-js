...
extension RelaySwiftUI.QueryNext.WrappedValue where O == AddFeedMutation {
    public func get(input: AddFeedInput, fetchKey: Any? = nil) -> RelaySwiftUI.QueryNext<AddFeedMutation>.Result {
