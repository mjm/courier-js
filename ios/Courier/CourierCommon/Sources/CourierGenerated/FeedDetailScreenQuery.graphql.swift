...
extension RelaySwiftUI.Query.WrappedValue where O == FeedDetailScreenQuery {
    public func get(id: String, fetchKey: Any? = nil) -> RelaySwiftUI.Query<FeedDetailScreenQuery>.Result {
