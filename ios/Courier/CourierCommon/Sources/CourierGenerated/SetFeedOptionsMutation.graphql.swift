...
extension RelaySwiftUI.Query.WrappedValue where O == SetFeedOptionsMutation {
    public func get(input: SetFeedOptionsInput, fetchKey: Any? = nil) -> RelaySwiftUI.Query<SetFeedOptionsMutation>.Result {
