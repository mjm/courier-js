...
export type ResolversTypes = {
  ...
  Cursor: Scalars['Cursor'],
  TweetConnection: Pager<types.Tweet, any>,
  ...
  Feed: types.Feed,
  PostConnection: Pager<types.Post, any>,
  PostEdge: Omit<PostEdge, 'node'> & { node: ResolversTypes['Post'] },
  Post: types.Post,
  PageInfo: PageInfo,
  Boolean: Scalars['Boolean'],
  TweetStatus: TweetStatus,
  SubscribedFeedConnection: Pager<types.SubscribedFeed, any>,
  SubscribedFeedEdge: PagerEdge<types.SubscribedFeed>,
  EventConnection: Pager<types.Event, any>,
  ...
  RefreshFeedPayload: Omit<RefreshFeedPayload, 'feed'> & { feed: ResolversTypes['Feed'] },
  SetFeedOptionsInput: SetFeedOptionsInput,
  SetFeedOptionsPayload: Omit<SetFeedOptionsPayload, 'feed'> & { feed: ResolversTypes['SubscribedFeed'] },
  DeleteFeedInput: DeleteFeedInput,
  DeleteFeedPayload: DeleteFeedPayload,
  CancelTweetInput: CancelTweetInput,
  CancelTweetPayload: Omit<CancelTweetPayload, 'tweet'> & { tweet: ResolversTypes['Tweet'] },
  UncancelTweetInput: UncancelTweetInput,
  UncancelTweetPayload: Omit<UncancelTweetPayload, 'tweet'> & { tweet: ResolversTypes['Tweet'] },
  PostTweetInput: PostTweetInput,
  PostTweetPayload: Omit<PostTweetPayload, 'tweet'> & { tweet: ResolversTypes['Tweet'] },
  EditTweetInput: EditTweetInput,
  EditTweetPayload: Omit<EditTweetPayload, 'tweet'> & { tweet: ResolversTypes['Tweet'] },
  SubscribeInput: SubscribeInput,
  SubscribePayload: Omit<SubscribePayload, 'user'> & { user: ResolversTypes['User'] },
  CancelSubscriptionInput: CancelSubscriptionInput,
  CancelSubscriptionPayload: Omit<CancelSubscriptionPayload, 'user'> & { user: ResolversTypes['User'] },
  ...
  FeedConnection: Pager<types.Feed, any>,
  FeedEdge: Omit<FeedEdge, 'node'> & { node: ResolversTypes['Feed'] },
};

export type AddDevicePayloadResolvers<ContextType = CourierContext, ParentType = ResolversTypes['AddDevicePayload']> = {
  deviceToken?: Resolver<ResolversTypes['DeviceToken'], ParentType, ContextType>,
};

export type AddFeedPayloadResolvers<ContextType = CourierContext, ParentType = ResolversTypes['AddFeedPayload']> = {
  feed?: Resolver<ResolversTypes['SubscribedFeed'], ParentType, ContextType>,
  feedEdge?: Resolver<ResolversTypes['SubscribedFeedEdge'], ParentType, ContextType>,
};

export type CancelSubscriptionPayloadResolvers<ContextType = CourierContext, ParentType = ResolversTypes['CancelSubscriptionPayload']> = {
  user?: Resolver<ResolversTypes['User'], ParentType, ContextType>,
};

export type CancelTweetPayloadResolvers<ContextType = CourierContext, ParentType = ResolversTypes['CancelTweetPayload']> = {
  tweet?: Resolver<ResolversTypes['Tweet'], ParentType, ContextType>,
};

export type CreditCardResolvers<ContextType = CourierContext, ParentType = ResolversTypes['CreditCard']> = {
...
export type CustomerResolvers<ContextType = CourierContext, ParentType = ResolversTypes['Customer']> = {
...
export type DeleteFeedPayloadResolvers<ContextType = CourierContext, ParentType = ResolversTypes['DeleteFeedPayload']> = {
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>,
};

export type DeviceTokenResolvers<ContextType = CourierContext, ParentType = ResolversTypes['DeviceToken']> = {
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>,
  token?: Resolver<ResolversTypes['String'], ParentType, ContextType>,
};

export type EditTweetPayloadResolvers<ContextType = CourierContext, ParentType = ResolversTypes['EditTweetPayload']> = {
  tweet?: Resolver<ResolversTypes['Tweet'], ParentType, ContextType>,
};

export type EventResolvers<ContextType = CourierContext, ParentType = ResolversTypes['Event']> = {
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>,
  ...
  boolValue?: Resolver<Maybe<ResolversTypes['Boolean']>, ParentType, ContextType>,
};

export type EventConnectionResolvers<ContextType = CourierContext, ParentType = ResolversTypes['EventConnection']> = {
...
export type EventEdgeResolvers<ContextType = CourierContext, ParentType = ResolversTypes['EventEdge']> = {
  cursor?: Resolver<ResolversTypes['Cursor'], ParentType, ContextType>,
  node?: Resolver<ResolversTypes['Event'], ParentType, ContextType>,
};

export type FeedResolvers<ContextType = CourierContext, ParentType = ResolversTypes['Feed']> = {
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>,
  ...
  posts?: Resolver<ResolversTypes['PostConnection'], ParentType, ContextType, FeedPostsArgs>,
};

export type FeedConnectionResolvers<ContextType = CourierContext, ParentType = ResolversTypes['FeedConnection']> = {
...
export type FeedEdgeResolvers<ContextType = CourierContext, ParentType = ResolversTypes['FeedEdge']> = {
  cursor?: Resolver<ResolversTypes['Cursor'], ParentType, ContextType>,
...
export type MutationResolvers<ContextType = CourierContext, ParentType = ResolversTypes['Mutation']> = {
  addFeed?: Resolver<ResolversTypes['AddFeedPayload'], ParentType, ContextType, MutationAddFeedArgs>,
  refreshFeed?: Resolver<ResolversTypes['RefreshFeedPayload'], ParentType, ContextType, MutationRefreshFeedArgs>,
  setFeedOptions?: Resolver<ResolversTypes['SetFeedOptionsPayload'], ParentType, ContextType, MutationSetFeedOptionsArgs>,
  deleteFeed?: Resolver<ResolversTypes['DeleteFeedPayload'], ParentType, ContextType, MutationDeleteFeedArgs>,
  cancelTweet?: Resolver<ResolversTypes['CancelTweetPayload'], ParentType, ContextType, MutationCancelTweetArgs>,
  uncancelTweet?: Resolver<ResolversTypes['UncancelTweetPayload'], ParentType, ContextType, MutationUncancelTweetArgs>,
  postTweet?: Resolver<ResolversTypes['PostTweetPayload'], ParentType, ContextType, MutationPostTweetArgs>,
  editTweet?: Resolver<ResolversTypes['EditTweetPayload'], ParentType, ContextType, MutationEditTweetArgs>,
  subscribe?: Resolver<ResolversTypes['SubscribePayload'], ParentType, ContextType, MutationSubscribeArgs>,
...
export type PostResolvers<ContextType = CourierContext, ParentType = ResolversTypes['Post']> = {
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>,
...
export type PostConnectionResolvers<ContextType = CourierContext, ParentType = ResolversTypes['PostConnection']> = {
...
export type PostEdgeResolvers<ContextType = CourierContext, ParentType = ResolversTypes['PostEdge']> = {
  cursor?: Resolver<ResolversTypes['Cursor'], ParentType, ContextType>,
  node?: Resolver<ResolversTypes['Post'], ParentType, ContextType>,
};

export type PostTweetPayloadResolvers<ContextType = CourierContext, ParentType = ResolversTypes['PostTweetPayload']> = {
  tweet?: Resolver<ResolversTypes['Tweet'], ParentType, ContextType>,
};
...
export type SendTestNotificationPayloadResolvers<ContextType = CourierContext, ParentType = ResolversTypes['SendTestNotificationPayload']> = {
  placeholder?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>,
};

export type SetFeedOptionsPayloadResolvers<ContextType = CourierContext, ParentType = ResolversTypes['SetFeedOptionsPayload']> = {
  feed?: Resolver<ResolversTypes['SubscribedFeed'], ParentType, ContextType>,
};

export type SubscribedFeedResolvers<ContextType = CourierContext, ParentType = ResolversTypes['SubscribedFeed']> = {
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>,
  feed?: Resolver<ResolversTypes['Feed'], ParentType, ContextType>,
  autopost?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType>,
};

export type SubscribedFeedConnectionResolvers<ContextType = CourierContext, ParentType = ResolversTypes['SubscribedFeedConnection']> = {
  edges?: Resolver<Array<ResolversTypes['SubscribedFeedEdge']>, ParentType, ContextType>,
  nodes?: Resolver<Array<ResolversTypes['SubscribedFeed']>, ParentType, ContextType>,
  pageInfo?: Resolver<ResolversTypes['PageInfo'], ParentType, ContextType>,
  totalCount?: Resolver<ResolversTypes['Int'], ParentType, ContextType>,
};

export type SubscribedFeedEdgeResolvers<ContextType = CourierContext, ParentType = ResolversTypes['SubscribedFeedEdge']> = {
  cursor?: Resolver<ResolversTypes['Cursor'], ParentType, ContextType>,
  node?: Resolver<ResolversTypes['SubscribedFeed'], ParentType, ContextType>,
};

export type SubscribePayloadResolvers<ContextType = CourierContext, ParentType = ResolversTypes['SubscribePayload']> = {
  user?: Resolver<ResolversTypes['User'], ParentType, ContextType>,
};

export type TweetResolvers<ContextType = CourierContext, ParentType = ResolversTypes['Tweet']> = {
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>,
  feed?: Resolver<ResolversTypes['SubscribedFeed'], ParentType, ContextType>,
  ...
  postAfter?: Resolver<Maybe<ResolversTypes['DateTime']>, ParentType, ContextType>,
  postedAt?: Resolver<Maybe<ResolversTypes['DateTime']>, ParentType, ContextType>,
  postedTweetID?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>,
};

export type TweetConnectionResolvers<ContextType = CourierContext, ParentType = ResolversTypes['TweetConnection']> = {
...
export type UserResolvers<ContextType = CourierContext, ParentType = ResolversTypes['User']> = {
  ...
  subscriptionStatusOverride?: Resolver<Maybe<ResolversTypes['SubscriptionStatus']>, ParentType, ContextType>,
  micropubSites?: Resolver<Array<ResolversTypes['String']>, ParentType, ContextType>,
  allTweets?: Resolver<ResolversTypes['TweetConnection'], ParentType, ContextType, UserAllTweetsArgs>,
};

export type UserSubscriptionResolvers<ContextType = CourierContext, ParentType = ResolversTypes['UserSubscription']> = {
...
export type Resolvers<ContextType = CourierContext> = {
  ...
  SendTestNotificationPayload?: SendTestNotificationPayloadResolvers<ContextType>,
