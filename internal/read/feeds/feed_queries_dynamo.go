...
func NewFeedQueriesDynamo(dynamo dynamodbiface.DynamoDBAPI, dynamoConfig db.DynamoConfig) *FeedQueriesDynamo {
	return &FeedQueriesDynamo{
		dynamo:       dynamo,
		dynamoConfig: dynamoConfig,
		loader:       newFeedLoaderDynamo(dynamo, dynamoConfig),
	}
}

func (q *FeedQueriesDynamo) Get(ctx context.Context, feedID model.FeedID) (*model.Feed, error) {
...
func newFeedLoaderDynamo(dynamo dynamodbiface.DynamoDBAPI, dynamoConfig db.DynamoConfig) *dataloader.Loader {
