...
func (x *PostTweetTask) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PostTweetTask) ProtoMessage() {}

func (x *PostTweetTask) ProtoReflect() protoreflect.Message {
	mi := &file_tasks_proto_msgTypes[0]
...
// Deprecated: Use PostTweetTask.ProtoReflect.Descriptor instead.
func (*PostTweetTask) Descriptor() ([]byte, []int) {
	return file_tasks_proto_rawDescGZIP(), []int{0}
}

func (x *PostTweetTask) GetUserId() string {
	if x != nil {
		return x.UserId
	}
	return ""
...
func (x *PostTweetTask) GetTweetId() string {
	if x != nil {
		return x.TweetId
	}
	return ""
...
func (x *PostTweetTask) GetAutopost() bool {
	if x != nil {
		return x.Autopost
	}
	return false
...
func (x *PostTweetTask) GetFeedId() string {
	if x != nil {
		return x.FeedId
	}
	return ""
...
func (x *PostTweetTask) GetItemId() string {
	if x != nil {
		return x.ItemId
	}
	return ""
...
var file_tasks_proto_rawDesc = []byte{
	0x0a, 0x0b, 0x74, 0x61, 0x73, 0x6b, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x0e, 0x63,
	0x6f, 0x75, 0x72, 0x69, 0x65, 0x72, 0x2e, 0x74, 0x77, 0x65, 0x65, 0x74, 0x73, 0x22, 0x91, 0x01,
	0x0a, 0x0d, 0x50, 0x6f, 0x73, 0x74, 0x54, 0x77, 0x65, 0x65, 0x74, 0x54, 0x61, 0x73, 0x6b, 0x12,
	...
	0x74, 0x49, 0x64, 0x12, 0x1a, 0x0a, 0x08, 0x61, 0x75, 0x74, 0x6f, 0x70, 0x6f, 0x73, 0x74, 0x18,
	0x03, 0x20, 0x01, 0x28, 0x08, 0x52, 0x08, 0x61, 0x75, 0x74, 0x6f, 0x70, 0x6f, 0x73, 0x74, 0x12,
	0x17, 0x0a, 0x07, 0x66, 0x65, 0x65, 0x64, 0x5f, 0x69, 0x64, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09,
	0x52, 0x06, 0x66, 0x65, 0x65, 0x64, 0x49, 0x64, 0x12, 0x17, 0x0a, 0x07, 0x69, 0x74, 0x65, 0x6d,
	0x5f, 0x69, 0x64, 0x18, 0x05, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x69, 0x74, 0x65, 0x6d, 0x49,
	0x64, 0x42, 0x08, 0x5a, 0x06, 0x74, 0x77, 0x65, 0x65, 0x74, 0x73, 0x62, 0x06, 0x70, 0x72, 0x6f,
	0x74, 0x6f, 0x33,
}
...
var file_tasks_proto_goTypes = []interface{}{
	(*PostTweetTask)(nil), // 0: courier.tweets.PostTweetTask
}
