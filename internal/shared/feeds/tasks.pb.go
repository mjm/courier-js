...
func (x *RefreshFeedTask) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*RefreshFeedTask) ProtoMessage() {}

func (x *RefreshFeedTask) ProtoReflect() protoreflect.Message {
	mi := &file_tasks_proto_msgTypes[0]
...
// Deprecated: Use RefreshFeedTask.ProtoReflect.Descriptor instead.
func (*RefreshFeedTask) Descriptor() ([]byte, []int) {
	return file_tasks_proto_rawDescGZIP(), []int{0}
}

func (x *RefreshFeedTask) GetUserId() string {
	if x != nil {
		return x.UserId
	}
	return ""
...
func (x *RefreshFeedTask) GetFeedId() string {
	if x != nil {
		return x.FeedId
	}
	return ""
...
var file_tasks_proto_rawDesc = []byte{
	...
	0x6f, 0x75, 0x72, 0x69, 0x65, 0x72, 0x2e, 0x66, 0x65, 0x65, 0x64, 0x73, 0x22, 0x43, 0x0a, 0x0f,
	0x52, 0x65, 0x66, 0x72, 0x65, 0x73, 0x68, 0x46, 0x65, 0x65, 0x64, 0x54, 0x61, 0x73, 0x6b, 0x12,
	0x17, 0x0a, 0x07, 0x75, 0x73, 0x65, 0x72, 0x5f, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09,
	0x52, 0x06, 0x75, 0x73, 0x65, 0x72, 0x49, 0x64, 0x12, 0x17, 0x0a, 0x07, 0x66, 0x65, 0x65, 0x64,
	0x5f, 0x69, 0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x66, 0x65, 0x65, 0x64, 0x49,
	0x64, 0x42, 0x07, 0x5a, 0x05, 0x66, 0x65, 0x65, 0x64, 0x73, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74,
	0x6f, 0x33,
}
...
var file_tasks_proto_goTypes = []interface{}{
	(*RefreshFeedTask)(nil), // 0: courier.feeds.RefreshFeedTask
}
